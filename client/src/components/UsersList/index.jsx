...
export const UserList = () => {
  ...
  const { paginatedResults, allUsers } = useSelector((state) => state);
      ...
      {edit ? (
        <>
          ...
          <div class="h-50 d-flex justify-content-center align-items-end ">
            <div>
              <button class="btn btn-primary mt-3" onClick={handleReset}>
                {" "}
                Volver{" "}
              </button>
            </div>
        ...
        <div class=" d-flex flex-column  justify-content-center align-items-center ">
          {" "}
          <div>
            <button class="btn btn-primary ms-3 " onClick={setCreate}>
              {" "}
              Create User{" "}
            </button>
          </div>
            ...
            {paginatedResults.map((user, index) => {
              return (
                <div class=" d-flex  w-100 justify-content-center">
                  <div
                    key={user.id}
                    class="list-group-item  list-group-item-dark  d-flex  w-75 justify-content-between "
                  >
                    <div class="text-dark">{user.mail}</div>
